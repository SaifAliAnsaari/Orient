                ...
                <table class="report-preview" border="0" align="center" cellpadding="3" cellspacing="3">
                    <tbody>
                        <tr>
                            ...
                            <td width="50%" align="right"><strong>Report Prepared By: </strong>{{ $core->created_by }}</td>
                        </tr>
                        <tr>
                            <td height="10"></td>
                            <td height="10"></td>
                        ...
                        <tr>
                            <td colspan="2"><button type="submit" class="btn btn-primary mr-2 mb-10">Save PDF</button>
                                ...
                                <button type="submit" class="btn btn-cancel mb-10">Cancel</button></td>
                        </tr>
                    </tbody>
                </table>
