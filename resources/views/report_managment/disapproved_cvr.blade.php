...
<div class="row mt-2 mb-3">
    <div class="col-lg-6 col-md-6 col-sm-6">
        <h2 class="_head01">CVR <span> Management</span></h2>
    </div>

    <div class="col-lg-6 col-md-6 col-sm-6">
        <ol class="breadcrumb">
            <li><a href="#"><span>CVR</span></a></li>
    ...
    <div class="col-md-12">
        <div class="card">
            ...
            <div class="body">
                ...
                <a href="/cvr_preview/{{$data->cvr_id}}"><button type="submit" class="btn btn-primary mt-10">CVR Preview</button></a>
