    ...
    <div class="modal-dialog modal-lg modal-dialog-centered">
        <div class="modal-content top_border">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLongTitle">Approve <span> Service Visit Report</span></h5>
                ...
                <div class="row form-wrap p-0 PT-10">
                    <div class="col-3">
                        <div class="custom-control custom-radio">
                            <input checked class="custom-control-input" type="radio" name="approval_radio"
                                id="txt-rateY" value='1'>
                            <label class="custom-control-label" for="txt-rateY">Approve</label>
                        </div>
                    </div>
                    <div class="col-3">
                        <div class="custom-control custom-radio">
                            <input class="custom-control-input" type="radio" name="approval_radio" id="txt-ratN"
                                value='2'>
            ...
            <div class="modal-footer border-0">
                <button type="submit" class="btn btn-cancel cancel_svr_modal" data-dismiss="modal"
            ...
            <div id="printResult">
                ...
                <div class="body">
                    ...
                    <div class="report-preview">
                        ...
                        <div class="row">
                            <div class="col-md-6 p-0"><strong>Date Of Report:</strong> {{ $core->report_created_at }}
                            </div>
                            <div class="col-md-6 p-0 _RtextP "><strong>Report Prepared By:</strong>
                                {{ $core->created_by }}</div>

                        </div>

                        <div class="row PT-10">
                            <div class="col-md-6 style-bg"><strong>Date Of Visit: </strong> {{ $core->date_of_visit }}
                            </div>
                        ...
                        <div class="row PT-30">
                            <div class="col-12 p-0">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-3"><i class="fa fa-check"></i> {{ $core->purpose_of_visit }}
                                    </div>
                                    <?php }   
                                    ?>
                                </div>
