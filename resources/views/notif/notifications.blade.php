    ...
    <div class="col-md-12">
        <div class="card">
            ...
            <div class="body">
                ...
                <a
                    href="{{ ($notifications->cvr_id ? '/cvr_preview'.'/'.$notifications->cvr_id : ($notifications->customer_id ? '/CustomerProfile'.'/'.$notifications->customer_id : ($notifications->svr_id ? '/svr_preview'.'/'.$notifications->svr_id : '/complaints_list'))) }}">
