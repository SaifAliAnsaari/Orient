        ...
        <div class="card">
            ...
            <div class="body">
                ...
                @if(!empty($all_notif))
                    ...
                    <a href="{{ ($notifications->cvr_id ? '/cvr_preview'.'/'.$notifications->cvr_id : ($notifications->customer_id ? '/CustomerProfile'.'/'.$notifications->customer_id : ($notifications->svr_id ? '/edit_svr'.'/'.$notifications->svr_id : '/complaints_list'))) }}"> <div class="alert alert-warning alert-dismissible fade show alert-color _NF-se" role="alert">
                           <img src="{{'/images/profile-img--.jpg'}}" class="NU-img float-none mb-0" alt="">
