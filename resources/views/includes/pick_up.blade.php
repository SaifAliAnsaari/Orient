...
<div id="product-cl-sec">
                                            ...
                                            {{-- <div class="row">
                                                <div class="col-md-12">
                                                    <div class="form-s2">
                                                        ...
                                                        <div>
                                                            <select class="form-control sd-type required" id="location" name="location" multiple="multiple">
    ...
    <div class="_cl-bottom">
        <button type="button" class="btn btn-primary mr-2" id="savePickUp">Save</button>
        <button type="button" class="btn btn-primary mr-2 updatePickUp" id="" style = "display:none;">Update</button>
